                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <form
                                                            action="{{ route('categorie.restoredelete', $categorie->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('put')
                                                            <button type="submit" class="dropdown-item"><i
                                                                    class="bi bi-arrow-counterclockwise"></i> Khôi
                                                                phục</button>
                                                            <a href="{{ route('categorie_destroy', $categorie->id) }}"
                                                                id="{{ $categorie->id }}" class="dropdown-item"><i
                                                                    class="bx bx-trash me-1"
                                                                    onclick="return confirm('Bạn có muốn xóa ?')"></i>Xóa</a>
                                                        </form>
                                                    </div>
                                                </div>
