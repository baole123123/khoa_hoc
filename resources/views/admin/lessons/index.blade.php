                    ...
                    <div class="card-body">
                        <div class="col-lg-12">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="{{ route('lessons.create') }}" class="btn btn-primary">Thêm</a>
                                </div>
                            </div>
                        </div>
                        <table class="table">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{route('lessons.edit',$item->id)}}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                <a class="dropdown-item" href="{{route('lessons.show',$item->id)}}"><i class='bx bx-show-alt'></i> Show</a>

                                                </form>


                                                <form method="POST" action="{{route('lessons.destroy' ,$item->id)}}">
                                                    @csrf
                                                    @method('DELETE')
